<?php
/**
 * PizzaTier — Checkout Bar: Rustic (Fornaia/Terraforno)
...
?>
<div class="pztc-checkout-bar pztc-checkout-bar--rustic"
     id="pztc-checkout-bar-<?php echo esc_attr($instance_id); ?>"
     data-instance="<?php echo esc_attr($instance_id); ?>">

    <div class="pztc-rustic-bar__divider"></div>
    ...
    <div class="pztc-bar-row">
        ...
        <button type="button"
                ...
                data-instance="<?php echo esc_attr($instance_id); ?>"
                aria-live="polite">
            🍕 <?php esc_html_e('Order Now', 'pizzatier'); ?>
        </button>
    </div>

    <?php if ($show_notes) : ?>
    <div class="pztc-bar-notes">
        <label class="pztc-bar-notes__label" for="pztc-note-rp-<?php echo esc_attr($instance_id); ?>">
            <?php esc_html_e('Notes for the kitchen', 'pizzatier'); ?>
        </label>
        <textarea id="pztc-note-rp-<?php echo esc_attr($instance_id); ?>"
