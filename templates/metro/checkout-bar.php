...
?>
<div class="pztc-checkout-bar pztc-checkout-bar--metro"
     id="pztc-checkout-bar-<?php echo esc_attr($instance_id); ?>"
     data-instance="<?php echo esc_attr($instance_id); ?>">

    <?php if ($show_notes) : ?>
    <div class="pztc-bar-notes">
        <label class="pztc-bar-notes__label" for="pztc-note-mt-<?php echo esc_attr($instance_id); ?>">
            <?php esc_html_e('Special instructions', 'pizzatier'); ?>
        </label>
        <textarea id="pztc-note-mt-<?php echo esc_attr($instance_id); ?>"
