<?php
/**
 * PizzaTierPro — Checkout Bar: PocketPie
 * Dark coal/amber, mobile-first, full-width amber CTA.
 */
...
?>
<div class="pztpro-checkout-bar pztpro-checkout-bar--pocketpie"
     id="pztpro-checkout-bar-<?php echo esc_attr($instance_id); ?>"
     data-instance="<?php echo esc_attr($instance_id); ?>">

    <div class="pztpro-pp-bar__meta">
    ...
    <div class="pztpro-pp-bar__actions">
        <?php if ($show_qty) : ?>
        ...
        <button type="button"
                ...
                data-instance="<?php echo esc_attr($instance_id); ?>"
                aria-live="polite">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/></svg>
