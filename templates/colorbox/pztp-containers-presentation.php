...
/*
 * Colorbox registers the [pizzatier-visualizer] shortcode.
 * This is the shortcode that pages actually use (e.g. [pizzatier-visualizer id="glass-demo-ui"]).
 * It outputs the full Colorbox UI: sticky split-screen pizza + tabbed builder.
...
function pizzatier_toppings_visualizer_func( $atts = array() ) {
    ...
    return '<!-- Colorbox: pizzatier_toppings_menu_func not found -->';
}
