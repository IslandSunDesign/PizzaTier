<?php
/**
 * Checkout Bar Layout: stacked-compact
 *
 * Size / price stacked above a full-width CTA, with optional qty inline.
 * Space-efficient for narrow columns and mobile layouts.
 *
...
?>
<div class="<?php echo esc_attr( H::root_classes( 'stacked-compact', $checkout_bar_template_slug ) ); ?>"
     id="pztc-checkout-bar-<?php echo esc_attr( $instance_id ); ?>"
     data-instance="<?php echo esc_attr( $instance_id ); ?>"
     data-layout="stacked-compact">
