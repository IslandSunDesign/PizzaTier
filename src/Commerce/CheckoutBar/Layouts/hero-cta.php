<?php
/**
 * Checkout Bar Layout: hero-cta
 *
 * Centered, large price display with an oversized full-width CTA
 * underneath. Dominant visual treatment suited to landing-page style
 * embeds where the builder IS the page.
 *
...
?>
<div class="<?php echo esc_attr( H::root_classes( 'hero-cta', $checkout_bar_template_slug ) ); ?>"
     id="pztc-checkout-bar-<?php echo esc_attr( $instance_id ); ?>"
     data-instance="<?php echo esc_attr( $instance_id ); ?>"
     data-layout="hero-cta">
