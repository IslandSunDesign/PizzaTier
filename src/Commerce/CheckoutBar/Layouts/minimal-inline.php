<?php
/**
 * Checkout Bar Layout: minimal-inline
 *
 * Small, unboxed row that sits flush with surrounding content —
 * thin top rule, outline button, no shadow. Pairs well with minimalist
 * templates or editorial-style pages where heavy UI would feel wrong.
 *
...
?>
<div class="<?php echo esc_attr( H::root_classes( 'minimal-inline', $checkout_bar_template_slug ) ); ?>"
     id="pztc-checkout-bar-<?php echo esc_attr( $instance_id ); ?>"
     data-instance="<?php echo esc_attr( $instance_id ); ?>"
     data-layout="minimal-inline">
